...
export default function DatabasePanel({ onClose, initialTab = 'tables' }) {
    ...
    <div className="glass-panel flex flex-col w-[720px] max-w-[95vw] max-h-[80vh] shadow-xl">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-osint-border">
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded text-[11px] font-medium border transition-colors ${
                tab === t.id
                  ...
                  : 'bg-transparent text-osint-muted border-osint-border hover:text-neon-cyan hover:border-neon-cyan/40'
              }`}
            >
              {t.label}
            </button>
        ...
        {onClose && (<button
          type="button"
          onClick={onClose}
          className="text-osint-muted hover:text-neon-red text-sm px-1.5"
          title="Close"
        >
          ✕
        </button>)}
