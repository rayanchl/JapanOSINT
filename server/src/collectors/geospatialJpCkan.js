/**
 * geospatial.jp MLIT CKAN catalog
 * https://www.geospatial.jp/ckan/api/3/action/package_search
 */

const API_URL = 'https://www.geospatial.jp/ckan/api/3/action/package_search?rows=10';
...
export default async function collectGeospatialJpCkan() {
  ...
  const features = [{
    ...
    properties: { name: 'geospatial.jp CKAN', total_packages: count, source: source === 'live' ? 'geospatial_jp' : 'geospatial_jp_seed' },
  }];
  return {
