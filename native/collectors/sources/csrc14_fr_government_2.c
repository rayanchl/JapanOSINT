/* UNVERIFIED candidate fr_government sources (24), part 2.
...
VJSON(fr_datagouv_reuses, "fr-datagouv-reuses", "data.gouv.fr — Reuse Registry", "data.gouv.fr 再利用事例",
  "fr_government", "registry",
  "https://www.data.gouv.fr/api/1/reuses/?page_size=100",
  "data",
  "fr", "[\"france\",\"opendata\",\"datagouv\",\"registry\",\"reuses\"]", 86400,
  "Applications and analyses built on French public data, linked to their source datasets.");

VJSON(fr_datagouv_topics, "fr-datagouv-topics", "data.gouv.fr — Topic Registry", "data.gouv.fr トピック一覧",
  "fr_government", "registry",
  "https://www.data.gouv.fr/api/1/topics/?page_size=100",
  "data",
  "fr", "[\"france\",\"opendata\",\"datagouv\",\"registry\",\"topics\"]", 86400,
