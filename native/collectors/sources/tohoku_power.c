/* collectors/infrastructure/sources/tohoku_power.c
 * Port of server/src/collectors/tohokuPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "tohoku-power"
#define META_SRC   "tohoku_power"
#define OPERATOR   "東北電力ネットワーク"
#define CSV_URL    "https://setsuden.nw.tohoku-epco.co.jp/common/demand/juyo_05_TOHOKU.csv"
#define HQ_LAT     38.2682
#define HQ_LON     140.8694
