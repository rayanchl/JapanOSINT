/* collectors/infrastructure/sources/chubu_power.c
 * Port of server/src/collectors/chubuPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "chubu-power"
#define META_SRC   "chubu_power"
#define OPERATOR   "中部電力パワーグリッド"
#define CSV_URL    "https://denki-yoho.chuden.jp/denki_yoho_content_data/juyo_cepco003.csv"
#define HQ_LAT     35.1815
#define HQ_LON     136.9066
