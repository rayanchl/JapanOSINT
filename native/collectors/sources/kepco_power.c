/* collectors/infrastructure/sources/kepco_power.c
 * Port of server/src/collectors/kepcoPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "kepco-power"
#define META_SRC   "kepco_power"
#define OPERATOR   "関西電力送配電"
#define CSV_URL    "https://www.kansai-td.co.jp/yamasou/juyo1_kansai.csv"
#define HQ_LAT     34.6937
#define HQ_LON     135.5023
...
static const source_def kepco_power_def = {
  .id = SOURCE_ID, .collector = "infrastructure",
  .name = "KEPCO Power Usage", .name_ja = "関西電力 電力使用状況",
  .update_interval_sec = 300, .run = run };
REGISTER_SOURCE(kepco_power_def)
