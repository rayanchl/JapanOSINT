/* collectors/sources/kepco_power.c
 * 関西電力送配電 の denki-yoho (電力需給) 日次CSV → the current actual demand as ONE
...
static const denki_cfg CFG = {
  .source_id   = "kepco-power",
  .meta_src    = "kepco_power",
  .operator_ja = "関西電力送配電",
  .area_code   = "06",
  .url_fmt     = "https://www.kansai-td.co.jp/yamasou/juyo_06_%s.csv",
...
static const source_def kepco_power_def = {
  .id = "kepco-power", .collector = "infrastructure",
