/* collectors/sources/academic2_world.c
 * OSINT services — additional scholarly / research pivots, all keyless & LIVE.
 * On-demand entity pivot (ctx->entity). One run() dispatches on ctx->source_id.
 *
 ...
 *
 * HONESTY: every branch REAL-fetches the public API and emits ONLY parsed real
 * fields, or honest-empty (return 0) on fetch failure / no matches. Nothing is
 * synthesized. */
#include "../../source.h"
