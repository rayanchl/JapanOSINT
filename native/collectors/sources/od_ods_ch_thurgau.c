...
static const char *URL =
  "https://data.tg.ch/api/explore/v2.1/catalog/datasets?limit=20&order_by=dataset_id";
...
static const source_def od_ods_ch_thurgau_def = {
  ...
  .url = "https://data.tg.ch/api/explore/v2.1/catalog/datasets?limit=20&order_by=dataset_id",
