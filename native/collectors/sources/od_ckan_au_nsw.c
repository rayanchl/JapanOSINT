...
static const char *URL =
  "https://data.nsw.gov.au/data/api/3/action/package_search?rows=20&sort=id%20asc";
...
static const source_def od_ckan_au_nsw_def = {
  ...
  .url = "https://data.nsw.gov.au/data/api/3/action/package_search?rows=20&sort=id%20asc",
