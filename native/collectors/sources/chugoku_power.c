/* collectors/infrastructure/sources/chugoku_power.c
 * Port of server/src/collectors/chugokuPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "chugoku-power"
#define META_SRC   "chugoku_power"
#define OPERATOR   "中国電力ネットワーク"
#define CSV_URL    "https://www.energia.co.jp/nw/jukyuu/sys/juyo-d1-j.csv"
#define HQ_LAT     34.3966
#define HQ_LON     132.4596
...
static const source_def chugoku_power_def = {
  .id = SOURCE_ID, .collector = "infrastructure",
  .name = "Chugoku Electric Power", .name_ja = "中国電力 電力使用状況",
  .update_interval_sec = 300, .run = run };
REGISTER_SOURCE(chugoku_power_def)
