...
static const char *URL =
  "https://opendata.muenchen.de/api/3/action/package_search?rows=20&sort=id%20asc";
...
static const source_def od_ckan_de_muenchen_def = {
  ...
  .url = "https://opendata.muenchen.de/api/3/action/package_search?rows=20&sort=id%20asc",
