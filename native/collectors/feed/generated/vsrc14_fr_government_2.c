...
VJSON(fr_datagouv_q_recensement, "fr-datagouv-q-recensement", "data.gouv.fr — Census Datasets", "data.gouv.fr censusデータセット",
  ...
  "https://www.data.gouv.fr/api/1/datasets/?page_size=1000&q=recensement&sort=created", /* sort=created ties re-served 2 datasets across 100-row page boundaries and skipped 2 (338 fetched, 336 distinct); page_size=1000 is honoured and returned all 338 distinct in one page, 2026-09-15 */
  "data",
...
VJSON(fr_datagouv_q_reseau, "fr-datagouv-q-reseau", "data.gouv.fr — Networks Datasets", "data.gouv.fr networksデータセット",
  ...
  "https://www.data.gouv.fr/api/1/datasets/?page_size=1000&q=réseau&sort=created", /* sort=created ties across 100-row page boundaries: 1,533 emitted, 1,531 stored (2026-09-14); page_size=1000 is honoured (see fr-datagouv-q-recensement) and cuts 15 boundaries to one */
  "data",
