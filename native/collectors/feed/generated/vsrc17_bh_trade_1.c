...
/* bh-imports-2021: an OpenDataSoft record carries no field the jsonlist id
 * precedence knows, so rows fell back to a hash of (title, link, date) and the
 * same commodity description recurred for every origin country. Live-verified
 * 2026-09-07 on a 100-record page: 100 distinct "n" (the file's own line
 * number) against 78 distinct "commodity". */
VJSON_KEYED(bh_imports_2021, "bh-imports-2021", "Bahrain — imports 2021 (HS line items)", "Bahrain — imports 2021 (HS line items)",
  "bh_trade", "trade",
