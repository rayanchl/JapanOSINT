...
VJSON(af_dportal_act_gh, "af-dportal-act-gh", "d-portal (IATI) — aid activities in Ghana", "d-portal (IATI) — aid activities in Ghana",
  "gh_aid", "aid",
  "https://d-portal.org/q?from=act&country_code=GH&limit=100&form=json",
  "rows",
...
VJSON(af_dportal_trans_gh, "af-dportal-trans-gh", "d-portal (IATI) — aid transactions in Ghana", "d-portal (IATI) — aid transactions in Ghana",
  "gh_aid", "aid",
  "https://d-portal.org/q?from=act,trans&trans_country_code=GH&limit=100&form=json",
  "rows",
  "en", "[\"gh\",\"aid\",\"batch17\",\"high-penetrancy\",\"detail-hop\"]", 86400,
