...
VJSON(af_dportal_act_bw, "af-dportal-act-bw", "d-portal (IATI) — aid activities in Botswana", "d-portal (IATI) — aid activities in Botswana",
  "bw_aid", "aid",
  "https://d-portal.org/q?from=act&country_code=BW&limit=100&form=json",
  "rows",
...
VJSON(af_dportal_trans_bw, "af-dportal-trans-bw", "d-portal (IATI) — aid transactions in Botswana", "d-portal (IATI) — aid transactions in Botswana",
  "bw_aid", "aid",
  "https://d-portal.org/q?from=act,trans&trans_country_code=BW&limit=100&form=json",
  "rows",
  "en", "[\"bw\",\"aid\",\"batch17\",\"high-penetrancy\",\"detail-hop\"]", 86400,
