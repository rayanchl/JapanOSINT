/* Deep-record cd_microdata sources (1), part 1 of 1.
 *
...
static const hp_source T[] = {
  { .id = "ihsn-microdata-cd",
    ...
    .url = "http://catalog.ihsn.org/index.php/api/catalog/search?format=json&country=Congo&ps=50",
