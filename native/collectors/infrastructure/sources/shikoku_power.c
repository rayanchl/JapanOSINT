/* collectors/infrastructure/sources/shikoku_power.c
 * Port of server/src/collectors/shikokuPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "shikoku-power"
#define META_SRC   "shikoku_power"
#define OPERATOR   "四国電力送配電"
#define CSV_URL    "https://www.yonden.co.jp/nw/denkiyoho/csv/juyo_shikoku.csv"
#define HQ_LAT     34.3401
#define HQ_LON     134.0434
