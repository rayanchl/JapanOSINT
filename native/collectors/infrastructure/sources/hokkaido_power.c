/* collectors/infrastructure/sources/hokkaido_power.c
 * Port of server/src/collectors/hokkaidoPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "hokkaido-power"
#define META_SRC   "hokkaido_power"
#define OPERATOR   "北海道電力ネットワーク"
#define CSV_URL    "https://denkiyoho.hepco.co.jp/area/data/juyo_01_hokkaido.csv"
#define HQ_LAT     43.0642
#define HQ_LON     141.3469
