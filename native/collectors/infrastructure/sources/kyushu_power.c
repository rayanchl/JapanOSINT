/* collectors/infrastructure/sources/kyushu_power.c
 * Port of server/src/collectors/kyushuPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "kyushu-power"
#define META_SRC   "kyushu_power"
#define OPERATOR   "九州電力送配電"
#define CSV_URL    "https://www.kyuden.co.jp/td_power_usages/csv/juyo-hourly-Kyushu.csv"
#define HQ_LAT     33.5902
#define HQ_LON     130.4017
