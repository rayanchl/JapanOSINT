/* collectors/infrastructure/sources/tepco_power.c
 * Port of server/src/collectors/tepcoPower.js (makeDenkiYohoCollector,
...
#define SOURCE_ID  "tepco-power"
#define META_SRC   "tepco_power"
#define OPERATOR   "東京電力パワーグリッド"
#define CSV_URL    "https://www.tepco.co.jp/forecast/html/images/juyo-d-j.csv"
#define HQ_LAT     35.6762
#define HQ_LON     139.6503
